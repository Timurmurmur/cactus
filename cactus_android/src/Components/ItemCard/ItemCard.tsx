...
import {View, Text, StyleSheet, ImageBackground, Alert, ActionSheetIOS, KeyboardAvoidingView, Modal} from 'react-native';
  ...
  render() {
    ...
    return(
      <View style={[cardItem.wrapper]}>
        ...
        <View style={{ backgroundColor: Colors.white, height: 274, justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <View style={{borderTopWidth: .5, borderTopColor: '#EBEBEB', width: '100%', height: '50%', justifyContent: 'center'}}>
              <TouchableHighlight style={{width: '100%', alignItems: 'center', justifyContent: 'center', height: '100%'}} underlayColor={'#fff'} onPress={(e) => { this.showFavouriteItemHandler(e); this.setState({ favourite: false })}}>
                <Text style={{color: Colors.lightGreen }}>Убрать</Text>
              </TouchableHighlight>
            </View>
            <View style={{ borderTopWidth: .5, borderTopColor: '#EBEBEB', width: '100%', height: '50%', justifyContent: 'center'}}>
              <TouchableHighlight style={{width: '100%', alignItems: 'center', justifyContent: 'center', height: '100%'}} underlayColor={'#fff'} onPress={(e) => { this.showFavouriteItemHandler(e) }}>
                <Text style={{color: Colors.lightGreen, fontWeight: 'bold'}}>Отмена</Text>
              </TouchableHighlight>
            </View>
            </View>
        </View>
        ...
        <TouchableHighlight underlayColor={'#FFF'} onPress={this.props.onPress}>
          <View style={cardItem.header}>
            <View style={cardItem.discountIcon}><Text style={{fontSize: 10, color: Colors.white,}}>- 9%</Text></View>
            <View style={cardItem.imageWrapper}>
              <View style={cardItem.image}>
                <ImageBackground source={require('../../../assets/images/iphone1.png')} style={{width: 105, height: 144, position: 'relative'}}>
                </ImageBackground>
              </View>
              <View style={{position: 'absolute', right: 10, top: 16, alignItems: 'center', justifyContent: 'space-between', height: '100%'}}>
                <View>
                  <View style={{width: 10, height: 10, backgroundColor: Colors.black, borderRadius: 2, marginBottom: 5}}></View>
                ...
                <View>
                  <View style={{marginBottom: 8}}><PhotoIcon width={16} height={16} color={Colors.gray}/></View>
                  <View><YouTubeIcon width={16} height={11} color={Colors.gray}/></View>
                </View>
              </View>
            </View>
...
export const cardItem = StyleSheet.create({
  wrapper: {borderRadius: 7, width: '48%',maxWidth: 186, marginBottom: 8, backgroundColor: Colors.white, },
  ...
  discountIcon: {zIndex: 20, left: 10, top: 10,position: 'absolute', paddingHorizontal: 5, paddingVertical: 2, backgroundColor: Colors.tintColor, borderRadius: 3},
  infoTitle: {color: Colors.gray, fontSize: 12, fontWeight: '500'},
  priceWrapper: {flexDirection: 'row', marginTop: 13, alignItems: 'center'},
  discountPriceWrapper: { position: 'relative', marginRight: 10 },
  discountPrice: {color: Colors.gray, fontSize: 10},
  discountPriceLine: {borderBottomColor: Colors.tintColor, borderBottomWidth: 1, position: 'absolute', zIndex: 100, bottom: 5, width: '100%'},
  price: {color: '#363636', fontSize: 14, fontWeight: '500'},
