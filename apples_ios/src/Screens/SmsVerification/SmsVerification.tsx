      ...
      <ScrollView style={{backgroundColor: COLOR.WHITE }}>
        <View style={[{  justifyContent: 'center' }]}>
          ...
          <View style={{marginTop: 110, alignItems: 'center'}}>
            <TouchableHighlight underlayColor={'transparent'} onPress={this.actionHanlder}><Text style={{ color: COLOR.TINT_COLOR, fontSize: 16,  }}>Не получили код?</Text></TouchableHighlight>
          </View>
        </View>
      </ScrollView>
      </>
