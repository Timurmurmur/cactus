...
import { HeartEmptyIcon } from '../../Components/Icons/Icons';
      ...
      <View style={{flex: 1, backgroundColor: COLOR.COMP_BG}}>
        <View style={[HeaderStyles.wrapper]}>
          <View style={{ flex: 1, maxWidth: 35, marginRight: 20, zIndex: 30 }}>
            <AntDesign.Button name="arrowleft" size={30} iconStyle={{ color: COLOR.WHITE, marginRight: -5}} backgroundColor="transparent" underlayColor={COLOR.GREEN} onPress={(e: any) => this.props.navigation.navigate("MainNavigation", { screen: "Main" })}/>
          </View>
          <View style={{flex: 5}}>
        ...
        <View style={basketStyles.footerWrapper}>
          ...
          <View style={basketStyles.navigationWrapper}>
            <View style={{width: '48%', maxWidth: 156}}>
              ...
              <Text style={{textAlign: 'center', textTransform: 'uppercase', color: COLOR.GREEN, fontFamily: 'Roboto-Medium'}}>В кредит</Text>
              </TouchableHighlight>
            </View>
            <View style={{width: '48%', maxWidth: 156}}>
              <TouchableHighlight underlayColor={COLOR.GREEN} onPress={e => this.props.navigation.navigate('Decoration')} style={[{backgroundColor: COLOR.GREEN}, basketStyles.navigationBtn ]}
              ><Text style={{textAlign: 'center', textTransform: 'uppercase', color: COLOR.WHITE, fontFamily: 'Roboto-Medium'}}>Оформить</Text>
              </TouchableHighlight>
            </View>
          </View>
        </View>
...
export const BasketItem = () => {
  return(
    <Swipeable rightButtons={[
      ...
      <View style={basketStyles.buttonWrapper}>
        <View style={{width: 44, height: 44, backgroundColor: COLOR.TEXT_GRAY, borderRadius: 50, justifyContent: 'center', alignItems: 'center'}}>
          <FontAwesome5 color={COLOR.WHITE} name="trash-alt" size={24}/>
        </View>
      </View>]}>
        <View style={[commonstyles.shadow, basketItem.wrapper]}>
          <View style={{width: '25%'}}>
            <Image source={require('../../../assets/images/phone.png')} style={{width: 72, height: 98}}/>
          </View>
          <View style={{width: '75%', paddingRight: 20, justifyContent: 'space-between', marginLeft: 10}}>
            ...
            <View style={basketItem.countContainer}>
              <View style={basketItem.countWrapper}>
                <TouchableHighlight style={[basketItem.countBtn, { marginRight: 10 }]}><FontAwesome name="minus" color={COLOR.BLACK} size={10}/></TouchableHighlight>
                <Text style={basketItem.count}>1</Text>
                <TouchableHighlight style={[basketItem.countBtn, { marginLeft: 10 }]}><FontAwesome name="plus" color={COLOR.BLACK} size={10}/></TouchableHighlight>
              </View>
...
export const basketItem = StyleSheet.create({
  wrapper: {paddingLeft: 25, paddingVertical: 12, flexDirection: 'row', width: '100%', justifyContent: 'space-between', marginBottom: 20},
  title: {fontSize: 14, fontFamily: 'Roboto-Medium', color: COLOR.BLACK},
  price: {fontSize: 14, color: COLOR.TEXT_GRAY, paddingTop: 4, paddingBottom: 8 },
  ...
  countBtn: {backgroundColor: COLOR.GRAY,width: 25, height: 25, borderRadius: 50, alignItems: 'center', justifyContent: 'center'},
  count: {fontSize: 18, fontFamily: 'Roboto-Medium', color: COLOR.BLACK},
  countPrice: {fontSize: 16, fontFamily: 'Roboto-Medium', color: COLOR.BLACK}
})
export const basketStyles = StyleSheet.create({
  ...
  footerWrapper: {position: 'absolute', bottom: 0, backgroundColor: COLOR.WHITE, width: '100%', padding: 16, elevation: 10},
  footerHeader: {flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: COLOR.GRAY},
  footerTitle: {fontSize: 16, color: COLOR.BLACK},
  totalPrice: {fontSize: 18, fontWeight: 'bold', color: COLOR.BLACK},
  navigationWrapper: { marginTop: 15, flexDirection: 'row', justifyContent: 'space-between', width: '100%'},
  navigationBtn: {paddingVertical: 15, borderColor: COLOR.GREEN, borderWidth: 1 ,borderRadius: 7, width: '100%'}
}) 